...
(rule (=> (and (inv a b c i al bl cl) (>= i al)
	       (not (forall ((pos Int)) (=> (and (<= 0 al)  (<= 0 pos) (< pos al)) (exists ((pos2 Int)) (or (and (<= 0 pos2) (< pos2 bl) (= (select b pos2) (select a pos))) (and (<= 0 pos2) (< pos2 cl) (= (select c pos2) (select a pos)))))))))  
	  fail))
(query fail)
