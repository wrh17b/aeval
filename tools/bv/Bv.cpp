...
int main (int argc, char ** argv)
{
  simpleCheck(argv[argc-1], getIntValue("--bw", 128, argc, argv),
              getIntValue("--val", 1, argc, argv), getBoolValue("--eqs", 1, argc, argv),
              getBoolValue("--adds", 1, argc, argv), getBoolValue("--bvnot", 0, argc, argv),
              getBoolValue("--ext", 0, argc, argv), getBoolValue("--conc", 1, argc, argv),
